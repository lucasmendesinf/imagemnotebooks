...
<html lang="pt-BR">
  ...
  <body>
    ...
    <main id="inicio">
      <section class="hero" aria-labelledby="hero-title">
        ...
        <div class="hero-content">
          ...
          <div class="hero-actions">
            ...
            <a class="button secondary" href="#contato">Solicitar atendimento</a>
          </div>
          <dl class="hero-metrics" aria-label="Diferenciais">
            ...
            <div>
              <dt>Coleta</dt>
              <dd>consulte disponibilidade</dd>
            </div>
            <div>
              <dt>Curitiba</dt>
      ...
      <section class="section services" id="servicos" aria-labelledby="services-title">
        ...
        <div class="service-grid">
          ...
          <article class="service-card">
            ...
            <h3>Monitores e TVs</h3>
            <p>Atendimento para problemas de imagem, energia, backlight e conectores em monitores e televisores selecionados.</p>
          </article>
          <article class="service-card">
      ...
      <section class="section split" id="processo" aria-labelledby="process-title">
        <div>
        ...
        <ol class="steps">
          <li>
            <span>1</span>
            <div>
              <h3>Contato e triagem</h3>
              <p>Conte o problema e envie marca, modelo e sintomas do equipamento.</p>
            </div>
          </li>
          <li>
            <span>2</span>
        ...
        <div class="contact-panel">
          ...
          <div class="contact-side">
            <div class="contact-actions">
              <a class="contact-link" href="tel:+554132651030">
                <span>Telefone</span>
                <strong>(41) 3265-1030</strong>
              </a>
              <a class="contact-link" href="https://wa.me/554132651030" target="_blank" rel="noopener">
                <span>WhatsApp</span>
                <strong>(41) 3265-1030</strong>
              </a>
